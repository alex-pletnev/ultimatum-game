...
- [ ] В CLAUDE.md проактивные триггеры добавить: «Diff трогает `application-prod.properties`
...
- [ ] `.claude/skills/pre-flight.md` — если задача трогает prod-профиль, добавить
